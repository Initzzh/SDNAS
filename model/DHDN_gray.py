...
class Net(nn.Module):
    def __init__(self):
        ...
        # # 64
        # self.conv_i = nn.Conv2d(in_channels=1, out_channels=64, kernel_size=1, stride=1, padding=0)
        # self.relu1 = nn.PReLU()
        ...
        # self.DCR_block64 = self.make_layer(_DCR_block, 64)
        # self.down3 = self.make_layer(_down, 64)
        # self.DCR_block41 = self.make_layer(_DCR_block, 64)
        # self.DCR_block42 = self.make_layer(_DCR_block, 64)
        # self.up3 = self.make_layer(_up, 64)
        # self.DCR_block33 = self.make_layer(_DCR_block, 64)
        # self.DCR_block34 = self.make_layer(_DCR_block, 64)
        # self.up2 = self.make_layer(_up, 64)
        ...
        # 32->64
        self.conv_i = nn.Conv2d(in_channels=1, out_channels=32, kernel_size=1, stride=1, padding=0)
        self.relu1 = nn.PReLU()
