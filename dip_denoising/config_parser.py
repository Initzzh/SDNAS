...
def main_parser():
    ...
    # parser.set_defaults(task_parsers="denoising")
    parser.add_argument("--dip_type", default = "eSURE_uniform")  # eSURE_uniform
    parser.add_argument("--gray", action="store_true" ,default=False)

    # denoising
    parser.add_argument("--eval_data", default="single_image") # CSet9
    parser.add_argument("--sigma", default=50, type=int)
    parser.add_argument("--lr", default=0.1, type=float)
    parser.add_argument('--reg_noise_std', default=1./20., type=float)
    ...
    parser.add_argument("--net_type", default="s2s", type=str) #UNet s2s_indi
    ...
    parser.add_argument('--desc', default="s2s_indi_sigma50", type=str)
    parser.add_argument("--exp_tag", default="CSet9", type=str)
