...
class conv_block_last_dropout(nn.Module):
    def __init__(self, ch_in, ch_out, p = 0.3,  down=False, act_fun='LeakyReLU', pad='reflection', group=1, bn_mode = "bn", bias=True):
        super(conv_block_last_dropout, self).__init__()
        self.dropout = nn.Dropout(p)
        self.conv1 = conv(ch_in, 64, kernel_size=3, stride=1 if down is False else 2, bias=bias, pad=pad, group=group)
        self.conv2 = conv(64, 32, kernel_size=3, stride=1, bias=bias, pad=pad, group=group)
        self.conv3 = conv(32, ch_out, kernel_size=3, stride=1, bias=bias, pad=pad, group=group)
        self.conv = nn.Sequential(
            self.dropout, self.conv1, bn(64, bn_mode if group == 1 else "groupNorm"), act(act_fun),
            self.dropout, self.conv2, bn(32, bn_mode if group == 1 else "groupNorm"), act(act_fun),
            self.dropout, self.conv3)
...
class conv_block_concat_dropout(nn.Module):
    def __init__(self, ch_in, ch_out, p = 0.3, act_fun='LeakyReLU', pad='reflection', group=1, bn_mode = "bn", bias=True):
        super(conv_block_concat_dropout, self).__init__()
        self.dropout = nn.Dropout(p) # dropout 失活
        self.conv1 = conv(ch_in, ch_out, kernel_size=3, stride=1, bias=bias, pad=pad, group=group)
        self.conv2 = conv(ch_out, ch_out, kernel_size=3, stride=1, bias=bias, pad=pad, group=group)
        self.up = nn.Sequential(
            bn(ch_in),
            self.dropout, self.conv1, bn(ch_out, bn_mode if group == 1 else "groupNorm"), act(act_fun),
            self.dropout, self.conv2, bn(ch_out, bn_mode if group == 1 else "groupNorm"), act(act_fun))
...
class S2Snet(nn.Module):
    def __init__(self, img_ch=3, output_ch=3, act_type="LeakyReLU", pad='reflection'):
        ...
        # self.Conv1 = conv_block_sp(ch_in=enc_ch[0], ch_out=enc_ch[0], down=True, act_fun=act_type, pad=pad)  # h/2,  w/2
...
#         self.conv11 = conv(img_ch, 48, kernel_size=3, stride=2 , bias=True, pad='reflection', group=1)
#         self.conv12 = conv(48, 48, kernel_size=3, stride=1, bias=True, pad='reflection', group=1)


#         self.Conv1 = nn.Sequential(
#             # self.conv11, bn(48, "bn"),act("LeakyReLU"),
#             # self.conv12, bn(48, "bn"),act("LeakyReLU")
#         #    self.covn1,bn(48),act(act_fun=act_type),
#         #     conv(48, 48, kernel_size=3, stride=1, pad= pad), bn(48),act(act_fun=act_type)
#             OPS['convolution_d'](img_ch, 48),
#             OPS['conv_3x3_leakyReLU'](48, 48)
#         ) 

#         self.conv21 = conv(48, 48, kernel_size=3, stride=2 , bias=True, pad='reflection', group=1)
#         self.conv22 = conv(48, 48, kernel_size=3, stride=1, bias=True, pad='reflection', group=1)

#         self.Conv2 = nn.Sequential(
#             # self.conv21, bn(48, "bn"), act("LeakyReLU"),
#             # self.conv22, bn(48, "bn"), act("LeakyReLU")
#             OPS['convolution_d'](48, 48),
#             OPS['conv_3x3_leakyReLU'](48, 48)
#         ) 

#         self.conv31 = conv(48, 48, kernel_size=3, stride=2 , bias=True, pad='reflection', group=1)
#         self.conv32 = conv(48, 48, kernel_size=3, stride=1, bias=True, pad='reflection', group=1)

#         self.Conv3 = nn.Sequential(

#             # self.conv31, bn(48, "bn"), act("LeakyReLU"),
#             # self.conv32, bn(48, "bn"), act("LeakyReLU")
#             OPS['convolution_d'](48, 48),
#             OPS['conv_3x3_leakyReLU'](48, 48)
#         ) 

#         self.conv41 = conv(48, 48, kernel_size=3, stride=2 , bias=True, pad='reflection', group=1)
#         self.conv42 = conv(48, 48, kernel_size=3, stride=1, bias=True, pad='reflection', group=1)

#         self.Conv4 = nn.Sequential(
#             # self.conv41, bn(48, "bn"), act("LeakyReLU"),
#             # self.conv42, bn(48, "bn"), act("LeakyReLU")
#             OPS['convolution_d'](48, 48),
#             OPS['conv_3x3_leakyReLU'](48, 48)
#         ) 


#         self.conv51 = conv(48, 48, kernel_size=3, stride=2 , bias=True, pad='reflection', group=1)
#         self.conv52 = conv(48, 48, kernel_size=3, stride=1, bias=True, pad='reflection', group=1)
#         self.Conv5 = nn.Sequential(
#             # self.conv51, bn(48, "bn"), act("LeakyReLU"),
#             # self.conv52, bn(48, "bn"), act("LeakyReLU")
#             OPS['convolution_d'](48, 48),
#             OPS['conv_3x3_leakyReLU'](48, 48)
#         ) 
...
#         self.up_conv51 = conv(48, 96, kernel_size=3, stride=1 , bias=True, pad='reflection', group=1)
#         self.Up_conv5 = nn.Sequential(
#             # self.up_conv51, bn(96, "bn"), act("LeakyReLU"),
...
#         self.up_conv41 = conv(48+96, 96, kernel_size=3, stride=1 , bias=True, pad='reflection', group=1)
#         self.up_conv42 = conv(96, 96, kernel_size=3, stride=1 , bias=True, pad='reflection', group=1)
#         self.Up_conv4 = nn.Sequential(
#             # self.up_conv41, bn(96, "bn"), act("LeakyReLU"),
#             # self.up_conv42, bn(96, "bn"), act("LeakyReLU")
#             # conv(48+96, 96, kernel_size=3, stride=1, pad=pad), bn(96), act(act_fun=act_type),
#             # conv(96, 96, kernel_size=3, stride=1, pad=pad), bn(96), act(act_fun=act_type)
#             OPS["bn"](96+48),
...
#         self.up_conv31 = conv(48+96, 96, kernel_size=3, stride=1 , bias=True, pad='reflection', group=1)
#         self.up_conv32 = conv(96, 96, kernel_size=3, stride=1 , bias=True, pad='reflection', group=1)
#         self.Up_conv3 = nn.Sequential(
#             # self.up_conv31, bn(96, "bn"), act("LeakyReLU"),
#             # self.up_conv32, bn(96, "bn"), act("LeakyReLU")
#             OPS["bn"](96+48),
#             OPS['conv_3x3_leakyReLU'](96+48, 96),
#             OPS['conv_3x3_leakyReLU'](96, 96)
...
#         self.up_conv21 = conv(48+96, 96, kernel_size=3, stride=1 , bias=True, pad='reflection', group=1)
#         self.up_conv22 = conv(96, 96, kernel_size=3, stride=1 , bias=True, pad='reflection', group=1)
...
#         self.up_conv11 = conv(48+96, 96, kernel_size=3, stride=1 , bias=True, pad='reflection', group=1)
#         self.up_conv12 = conv(96, 96, kernel_size=3, stride=1 , bias=True, pad='reflection', group=1)
#         self.Up_conv1 = nn.Sequential(
#             # self.up_conv11, bn(96, "bn"), act("LeakyReLU"),
#             # self.up_conv12, bn(96, "bn"), act("LeakyReLU")
#             # conv(48+96, 96, kernel_size=3, stride=1, pad=pad), bn(96), act(act_fun=act_type),
#             # conv(96, 96, kernel_size=3, stride=1, pad=pad), bn(96), act(act_fun=act_type)
#             OPS["bn"](96+48),
#             OPS['conv_3x3_leakyReLU'](96+48, 96),
...
#         )
#         self.conv_last = conv_block_last(96+img_ch, output_ch, act_fun=act_type, pad=pad)
...
# test
class S2SnetDropout(nn.Module):
    def __init__(self, img_ch=3, output_ch=3, act_type="LeakyReLU", pad='reflection'):
        super(S2SnetDropout, self).__init__()
        enc_ch = [48, 48, 48, 48, 48]  # fixed
        # dec_ch = [96, 96, 96, 96, 96]  # fixed
        dec_ch = [48, 48, 48, 48, 48]
        self.upsample = nn.Upsample(scale_factor=2)
        self.Maxpool = nn.MaxPool2d(kernel_size=2, stride=2)
        self.concat = Concat_layer(1)
        self.Conv1 = conv_block_sp(ch_in=img_ch, ch_out=enc_ch[0], down=True, act_fun=act_type, pad=pad)  # h/2,  w/2
        ...
        self.Up_conv4 = conv_block_concat_dropout(ch_in=dec_ch[4] + enc_ch[3], ch_out=dec_ch[3], act_fun=act_type, pad=pad)
        self.Up_conv3 = conv_block_concat_dropout(ch_in=dec_ch[3] + enc_ch[2], ch_out=dec_ch[2], act_fun=act_type, pad=pad)
        self.Up_conv2 = conv_block_concat_dropout(ch_in=dec_ch[2] + enc_ch[1], ch_out=dec_ch[1], act_fun=act_type, pad=pad)
        self.Up_conv1 = conv_block_concat_dropout(ch_in=dec_ch[1] + enc_ch[0], ch_out=dec_ch[0], act_fun=act_type, pad=pad)
        self.Conv_last1 = conv_block_last_dropout(dec_ch[0] + img_ch, output_ch, act_fun=act_type, pad=pad)  # concat
        self.Sig = nn.Sigmoid()
...
# test
class S2Snet1(nn.Module):
    def __init__(self, img_ch=3, output_ch=3, act_type="LeakyReLU", pad='reflection'):
        super(S2Snet1, self).__init__()
        enc_ch = [48, 48, 48, 48, 48]  # fixed
        # dec_ch = [96, 96, 96, 96, 96]  # fixed
        dec_ch = [48, 48, 48, 48, 48]
        self.upsample = nn.Upsample(scale_factor=2)
        ...
        self.Up_conv4 = conv_block_concat(ch_in=dec_ch[4], ch_out=dec_ch[3], act_fun=act_type, pad=pad)
        self.Up_conv3 = conv_block_concat(ch_in=dec_ch[3], ch_out=dec_ch[2], act_fun=act_type, pad=pad)
        self.Up_conv2 = conv_block_concat(ch_in=dec_ch[2], ch_out=dec_ch[1], act_fun=act_type, pad=pad)
        self.Up_conv1 = conv_block_concat(ch_in=dec_ch[1], ch_out=dec_ch[0], act_fun=act_type, pad=pad)
        self.Conv_last1 = conv_block_last(dec_ch[0] + img_ch, output_ch, act_fun=act_type, pad=pad)  # concat
        self.Sig = nn.Sigmoid()
    ...
    def forward(self, x):
        ...
        d5 = self.upsample(x6)  # h/16 w/16
        d5 = self.res_connect([d5, x4])
        # d5 = d5 + x4
        d4 = self.Up_conv4(d5)

        d4 = self.upsample(d4)  # h/8  w/8
        d4 = self.res_connect([d4, x3])
        # d4 = self.concat([d4, x3])
        # d4 = d4 + x3
        d3 = self.Up_conv3(d4)

        d3 = self.upsample(d3)  # h/4  w/4
        d3 = self.res_connect([d3, x2])
        # d3 = self.concat([d3, x2])
        # d3 = d3 + x2
        d2 = self.Up_conv2(d3)

        d2 = self.upsample(d2)  # h/2  w/2
        d2 = self.res_connect([d2, x1])
        # d2 = self.concat([d2, x1])
        # d2 = d2 + x1
        d1 = self.Up_conv1(d2)
